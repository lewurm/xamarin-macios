	...
	public static class SolutionGenerator
	{
		static void AddProjectToSolution (Harness harness, string sln_path, TextWriter solution, string project_path, out string configurations)
		{
			...
			configurations = string.Format (
                ...
                "\t\t{0}.Release-interpreter64|Any CPU.ActiveCfg = Release-interpreter64|Any CPU\n" +
                "\t\t{0}.Release-interpreter64|Any CPU.Build.0 = Release-interpreter64|Any CPU\n" +
                "\t\t{0}.Release-interpreter64|iPhoneSimulator.ActiveCfg = Release-interpreter64|Any CPU\n" +
                "\t\t{0}.Release-interpreter64|iPhoneSimulator.Build.0 = Release-interpreter64|Any CPU\n" +
                "\t\t{0}.Release-interpreter64|iPhone.ActiveCfg = Release-interpreter64|Any CPU\n" +
                "\t\t{0}.Release-interpreter64|iPhone.Build.0 = Release-interpreter64|Any CPU\n" +
		...
		public static void CreateSolution (Harness harness, IEnumerable<Target> targets, Target exeTarget, string infix)
		{
			...
			using (var writer = new StringWriter ()) {
                ...
                writer.WriteLine ("\t\tRelease-interpreter64|iPhone = Release-interpreter64|iPhone");
                ...
                var configurations = new string[] { "Debug", "Release", "Release-bitcode", "Release-interpreter64" };
				foreach (var target in targets) {
